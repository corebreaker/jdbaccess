...
package com.sun.legacy.rowset.internal;
...
import com.sun.legacy.misc.ReflectUtil;
import com.sun.legacy.rowset.CachedRowSetImpl;
import com.sun.legacy.rowset.JdbcRowSetResourceBundle;
          ...
          for (i = 1; i <= callerColumnCount; i++) {
                ...
                if (rsval instanceof Struct) {
                    ...
                    if (c != null) {
                        ...
                        SQLData obj = null;
                        try {
                            obj = ReflectUtil.newInstance(c, SQLData.class);
                        } catch (Exception ex) {
